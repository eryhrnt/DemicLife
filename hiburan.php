...
<html>
<head>
	<title>Forum Hiburan</title>
	<link rel="stylesheet" href="css/styleHiburan.css">
</head>
...
<body>
	...
	<section>
		...
		<a style="float: right;" href="indexHiburan.php" class="button3"><button><b>Forum</b></button></a>
		
	</section><hr>
</body>
<script type="text/javascript" src="javascript/hiburan.js"></script>
</html>